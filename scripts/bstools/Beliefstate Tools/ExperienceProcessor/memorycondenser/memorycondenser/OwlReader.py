...
class OwlIndividual:
    ...
    def nextAction(self):
        next_action = self.tagAttributeValues("knowrob:nextAction", "rdf:resource")
        
        if len(next_action) > 0:
            return next_action[0].split("#")[1]
    
    def previousAction(self):
        next_action = self.tagAttributeValues("knowrob:previousAction", "rdf:resource")
...
class OwlReader:
    ...
    def crawlOwl(self, domOwl):
        ...
        return {"task-tree-individuals": arrOwlTaskTreeIndividuals,
